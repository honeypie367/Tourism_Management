...
<div style="background-image:url('http://localhost/Tourism-Management-System-PHP/tms/images/tm5.jpg'); background-size:cover; ">
<div class="banner-1 " style="background:inherit;">
	<div class="container">
...
<div class="privacy">
	<div class="container">
		<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; 
		animation-delay: 0.5s; animation-name: fadeInDown; color:black;">My Tour History</h3>
		<form name="chngpwd" method="post" onSubmit="return valid();">
		 <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
				else if($msg){?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
	<p>
	<table border="1" width="100%" class="table" style="background-color:#fdebeb;">
<tr align="center">
<th>#</th>
<th>Booking Id</th>
<th>Package Name</th>	
